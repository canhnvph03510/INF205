...
function doSuccess(result){
	...
	for(var i=0; i<list.length; i++){
		strList += "<table border='0'><tr><td class='ab'><p>" + list[i].id +"</p></td><td><p>"+ list[i].name +"</p></td><td>"+ list[i].class +"</td><td class='ac'><p>"+ list[i].point + "</p></td></h3></tr></table>";
	}
